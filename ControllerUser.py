...
#Funciones de busqueda----------------------------------
    ...
    def control(self):
        while True:
                ...
                self.server_socket.sendto(jsonOK.encode('utf-8'), listenMethod[0])
                menu_dict = {
                            ...
                            if message1 == '1' and message2 == '1':
                                ...
                                try:
                                    ...
                                    while True:
                                        ...
                                        data, client_address = self.server_socket.recvfrom(buffer_size=2048)
                                        json_dataMessage = json.loads(data)
                                        messageExit = json_dataMessage("message")
                                        if messageExit == "Exit":
